...
# id5=9999
with open("pha_phaselink_nlloc_PRBC.pha","w") as file:
    ...
    for evl in range(len(idd)):
        ...
        for i in nlloc: #$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
            ...
            # if prbc_pol.contains(epicenter)==bool('True'):
                ...
                ############ Location line ####################
                file.write("# "+str(nyear)+" "+str(nmonth)+" "
                            +str(nday)+" "+str(nhour)+" "+str(nminute)+" "+
                            str(nsecond)+"  "+nlat+" "+nlon+"   "+ndepth+
                            " 0.00  0.00  0.00  "+str(rms)+"      "+str(ID)+"\n")
                ...
                with open(i) as fl:
                    ...
                    for s in range(18,(len(lins)-2)):
                        ...
                        file.write(str(ntwk)+""+str(stcn)+"    "+sec_diff+"  -1.000   "+phase+"\n")
